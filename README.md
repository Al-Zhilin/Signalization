...
-
- id пользователей добавляются в const String Users[], id пользователя можно узнать например через [него](https://web.telegram.org/a/#850434834) или [него](https://web.telegram.org/a/#6271337642) другого подобного бота.
