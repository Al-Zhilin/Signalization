...
В каталоге с проектом вы можете увидеть файлик "passwords_example.txt", который содержит все конфиденциальные и самые важные дефайны. Остальная их часть находиться в файлах .ino. Чтобы
