...
- [Нам понадобится](https://github.com/Al-Zhilin/Signalization/edit/main/README.md#нам-понадобится)
- [Краткий обзор настроек](https://github.com/Al-Zhilin/Signalization/edit/main/README.md#краткий-обзор-настроек)
- []()
- []()
- []()
- []()
