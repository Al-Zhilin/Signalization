...
- [Краткий обзор настроек:](#краткий-обзор-настроек)
   - [О файле "passwords.txt"](#о-файле-passwords.txt)
...
- 1) Задать все конфиденциальные данные в дефайнах файла 'passwords_example.txt' (*ssid* и *password*, )
