...
> [!NOTE]
> Подключение пожарных датчиков к микроконтроллеру, а так же их напряжение питания различаются для каждой модели датчиков!
> 
...
- Возможно перестроение кода, для других изменение сигнала при тревоги датчика, например для извещателей с изменяющимся током. Смотрите комментарии в коде и раздел **`Как это работает?`**
