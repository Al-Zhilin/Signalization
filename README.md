...
> - Проект не предназначен для совсем новичковых новичков, потому что для внесения изменений в стандратную прошивку (например при действиях с количеством используемых датчиков или реле) нужно хоть немного разбираться в базовых конструкциях программирования на **Wiring** (С++, модифицированный под _Arduino_), уметь понимать и грамотно перестраивать их под свои нужды.
