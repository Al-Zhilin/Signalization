...
/*           Сигнализация на основе ESP32 и бота в Телеграм
                                                                    2023 - 2025
*/
...
#define INIT_KEY 2                                                             //измените ключ, чтобы инициализировать EEPROM
...
GyverDS18Single ds(ThermoPin, false);
